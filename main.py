        ...
        <main class="row">
            <div class="row text-center">
                ...
                <div class="col-6">
                    <form>
                        <div class="mb-3">
                            <input style="text-align: center;" type="text" class="form-control" id="exampleInputName" placeholder="Имя"
                                   aria-describedby="emailHelp">
                        </div>
                        <div class="mb-3">
                            <input style="text-align: center;" type="email" placeholder="Email" class="form-control" id="exampleInputEmail1">
                        </div>
